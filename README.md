...
esophageal_cancer_prognostic_model/ 
├── predict.py 						# Prediction script (final version provided to you, includes C-index calculation) 
├── requirements.txt 				# Dependency list (content provided below) 
├── README.md 						# Project documentation (full template below)
├── new_data_test.xlsx				# Data sample
└── final_result/ 					# Training outputs (git ignores large files, only upload pkl) 
	└── trained_model_components.pkl 	# Trained model file (MUST upload!)
